"""
carl_train.py â€” CARL v4: Bob Learns For Real.
...
Fixes applied vs all previous versions:
  1. LIDAR EXCLUDES SELF-GEOMETRY (was the primary bug â€” Bob was blind)
...
# â”€â”€ Telemetry â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
blob_telemetry.start()

# â”€â”€ Physics world â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Brain â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Curriculum state â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
stats = load_stats()
MAX_FOOD_DIST = 1.5 # Start at 1.5m â€” no more free food
...
def check_event():
    blob_pos = data.geom("chassis").xpos
    # Food proximity (food has no collider â€” purely positional)
    if food_dist() < 0.35:
        return 'food'
...
def respawn_food(max_dist=None, random_pos=True):
    ...
    for _ in range(200):
        ...
        if math.hypot(fx, fy) > 0.9 and actual_dist >= min_d:
            ...
            return actual_dist
    # Fallback â€” still enforce distance
...
# â”€â”€ Curriculum advancement â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
try:
    ...
    while True:
        ...
        # â”€â”€ Sense â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        lidars    = get_lidar()
        ...
        if getattr(brain.drives, 'fatigue', 0.0) > 0.90 and distance_to_nest < 0.6:
            ...
            while getattr(brain.drives, 'fatigue', 0.0) > 0.05:
                if len(experience_buffer) > 10:
                    # â”€â”€ PHASE A: Classic Experience Replay (stabilize critic) â”€â”€
                    ...
                    # â”€â”€ PHASE B: DREAMER IMAGINED ROLLOUTS (train actor in simulation) â”€â”€
        ...
        # â”€â”€ Build observation â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ Compute reward â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ Brain step (sense -> think -> act) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ Autonomic Character Kinematics Translation Matrix â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ Event handling â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        if collision_cooldown > 0:
            ...
            if event == 'food':
                ...
                episode += 1
                collision_cooldown = 0
                # Reset cortisol on food reward â€” success should relieve stress
        ...
        # â”€â”€ Episode timeout â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        if steps_since_food >= MAX_EP_STEPS:
            ...
            episode += 1
            collision_cooldown = 0
            # Partial cortisol reset on episode boundary â€” fresh start matters
        ...
        # â”€â”€ Geometric wall escape (brainstem-level, overrides cortex) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ Cache valid experiences to fuel generative memory loops later â”€â”€
...
while ep_count < test_episodes:
    ...
    data.ctrl[ACT_IDS["act_w_left"]] = np.clip(left_tread * 2.0, -2.0, 2.0)
    data.ctrl[ACT_IDS["act_w_right"]] = np.clip(right_tread * 2.0, -2.0, 2.0)
